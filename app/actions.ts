...
const POST_BOUND_INSTRUCTION = [
  '重要規則：你只能引導學生觀察『這張貼文截圖裡實際看得到的內容』，例如帳號名稱、貼文文字、圖片內容、按讚數、留言（如果貼文截圖裡有顯示）。絕對禁止要求學生去查看『過去貼文』『歷史留言』『其他評價』『網路搜尋』等貼文截圖以外不存在的資訊，因為學生只能看到這一張貼文截圖，沒有其他資料來源。如果你想引導學生思考來源可信度，只能基於『這張截圖上寫了什麼、沒寫什麼』來提問。',
